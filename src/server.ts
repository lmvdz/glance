 ...
 *
 * @substrate exported for tests only — the round-trip merge is asserted directly in
 * tests/feature-decisions-merge.test.ts; the one production caller is the PATCH route in this file.
 */
