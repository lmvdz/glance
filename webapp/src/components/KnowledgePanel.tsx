    ...
    <PanelShell icon={<Library className="h-4 w-4 text-indigo-500" aria-hidden="true" />} title="Knowledge base" subtitle={subtitle}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 py-2.5 pl-10 pr-3 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/30"
        />
      </div>
