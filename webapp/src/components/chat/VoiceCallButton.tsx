    ...
    <button
      ...
      className={`flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${
        active
          ...
          : 'border-transparent text-ink-text hover:bg-amber-50 hover:text-amber-600 focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 text-ink-text-subtle dark:hover:bg-amber-900/20 dark:hover:text-amber-400 focus-visible:ring-offset-ink'
      }`}
    >
