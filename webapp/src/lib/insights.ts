...
// attentionItems / AttentionRow / fleetRoster: DELETED (deepen concern 17) — the room pivot
// superseded their panels and nothing rendered them (verified: zero non-test consumers). The live
// attention surfaces are the needs-you ladder (attention-ladder.ts) and MondaySurface. The
// harness scorecard below stays: sendCore/activeWork consumers are live.
