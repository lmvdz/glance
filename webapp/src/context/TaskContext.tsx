...
export type AppView = 'attention' | 'active' | 'tasks' | 'capabilities' | 'automation' | 'fleet-health' | 'heat' | 'activity-heatmap' | 'omp-graph' | 'task-class' | 'topology' | 'federation' | 'knowledge' | 'org';
