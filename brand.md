...
When `brand-design` runs, it will detect this deferred state, skip the "confirm overwrite" step, and proceed directly to the full brand setup. The resulting palette will be applied to the webapp theme and this file will be replaced with the real brand documentation.

_Deferred at: 2026-07-02_
