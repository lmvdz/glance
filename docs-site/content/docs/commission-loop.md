---
title: Commissioning loop
description: Agents that author, gate, and onboard their own specialized Flue workers.
---
...
[workflow engine](/docs/workflow-runtime) through a `CommissionExecutor` (action nodes
