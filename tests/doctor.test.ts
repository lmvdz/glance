...
test("a report full of unknowns never prints the all-clear", async () => {
	...
	const report = await runDoctor(probe({ daemon: boom, autonomy: boom, stateDir: boom, planeArmed: boom, gateImage: boom, projects: boom, webappBuilt: boom, zombieAgents: boom, harnessHooks: boom, adoption: boom }));
