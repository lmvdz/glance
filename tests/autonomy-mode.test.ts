...
test("mode transition persists requested mode and audits effective cap", async () => {
	...
	const mgr = new SquadManager({ stateDir, autoLand: false, store: {
		...
		async saveFeedback() {},
		async loadTranscripts() { return {}; },
		async saveTranscripts() {},
		async loadFeatures() { return []; },
		async saveFeatures() {},
		async loadCapabilities() { return { skills: {} }; },
		async saveCapabilities() {},
		async appendAudit(entry: unknown) { audits.push(entry); },
		async appendUsage() {},
		async listChannels() { return []; },
		async getChannel() { return undefined; },
		async putChannel() {},
		async listNodes() { return []; },
		async getNode() { return undefined; },
		async putNode() {},
		async bindNodeChannel() { return undefined; },
		async listNodeRecords() { return []; },
		async putNodeRecord() {},
		async deleteNodeRecords() { return 0; },
		async listDelegationGrants() { return []; },
		async putDelegationGrant() {},
		async listPlanProposals() { return []; },
		async putPlanProposal() {},
		async listChannelEntries() { return []; },
		async appendChannelEntry(entry: unknown) { return { ...(entry as object), seq: 0 }; },
		async nextChannelSeq() { return 0; },
		async listChannelMemberships() { return []; },
		async putChannelMembership() {},
		async getChannelReadCursor() { return undefined; },
		async putChannelReadCursor() {},
	} as unknown as import("../src/dal/store.ts").Store });
