...
//      src/config.ts. `envBoolAliased("PRIMARY", "LEGACY", …)` counts as a read of BOTH string
//      arguments (batch-3 review: the primary/legacy-alias reader added for the dead-alias fix).
