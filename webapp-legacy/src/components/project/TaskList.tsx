        ...
        return (
          <li key={i.id}>
            <button
              ...
              className={cn(
                "flex min-h-9 w-full items-center gap-2 rounded px-2 py-1.5 text-left text-sm hover:bg-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
